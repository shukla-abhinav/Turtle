...
window.title("Happy Holidays and Merry Christmas") 
...
text.write("Happy Holidays", font=("Youth Touch
                                   ", 30, "bold"), align="center") 
text.setposition(130, 140) 
text.color("dark green") 
text.write("Abhinav", font=("Avenir", 30, "bold"), align="right") 
text.color("black") 
text.write("Shukla", font=("Avenir", 30, "normal"), align="left") 
text.setx(50) 
