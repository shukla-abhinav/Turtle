...
if not web_based:
    ...
    screen.title("Happy Christmas from Abhinav Shukla")
...
text_1.write("Merry Christmas",
             font=("forte", max(int(30 / i_scale), 15), "bold"),
             align="center")
...
text_1.write("from",
             font=("Adobe Caslon Pro Bold", max(int(20 / i_scale), 10), "normal"),
             align="center")
if web_based:
...
#text_1.write("Abhinav Shukla", font=("Bradley Hand ITC", max(int(30 / i_scale), 15), "normal"),
#             align="center")
...
text_1.write("Abhinav Shukla", font=("Bradley Hand ITC", max(int(30 / i_scale), 15), "bold"),
             align="center")
